...
public class PushCallback implements MqttCallback {
    ...
    public void connectionLost(Throwable throwable) {
        ...
        logger.info("mqtt connect is closed, reconnecting");
    }

    @Override
    public void messageArrived(String s, MqttMessage mqttMessage) throws Exception {
        logger.info("mqtt-topic: " + s);
        logger.info("mqtt-Qos: " + mqttMessage.getQos());
        logger.info("mqtt-msg: " + new String(mqttMessage.getPayload()));
